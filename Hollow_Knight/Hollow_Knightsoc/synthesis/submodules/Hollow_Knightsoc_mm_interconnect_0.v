...
module Hollow_Knightsoc_mm_interconnect_0 (
	...
	wire  [108:0] load_s1_agent_rf_source_data;                                                       // load_s1_agent:rf_source_data -> load_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] load_s1_agent_rsp_fifo_out_data;                                                    // load_s1_agent_rsp_fifo:out_data -> load_s1_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> load_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // load_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [16:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> load_s1_agent:cp_channel
	...
	wire  [107:0] load_s1_agent_rp_data;                                                              // load_s1_agent:rp_data -> router_009:sink_data
	...
	Hollow_Knightsoc_mm_interconnect_0_router_002 router_007 (
	...
	Hollow_Knightsoc_mm_interconnect_0_router_008 router_008 (
	...
	Hollow_Knightsoc_mm_interconnect_0_router_002 router_018 (
	...
	Hollow_Knightsoc_mm_interconnect_0_cmd_mux cmd_mux_016 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hollow_Knightsoc_mm_interconnect_0_rsp_demux rsp_demux_016 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hollow_Knightsoc_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
